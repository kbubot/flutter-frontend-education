...
class twologin extends StatefulWidget {
  @override
  twologinState createState() => twologinState();
}

class twologinState extends State<twologin> {
...
class threelogin extends StatefulWidget {
  @override
  threeloginState createState() => threeloginState();
}

class threeloginState extends State<threelogin> {
